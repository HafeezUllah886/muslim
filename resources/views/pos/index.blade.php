                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <div class="input-group mb-3">
                                    <input type="number" class="form-control" id="received" oninput="changeReceived()" placeholder="Enter Received Amount" aria-label="Enter Received Amount" aria-describedby="basic-addon2">
  ...
  $('#fullScreen').click(function() {
      ...
      if (document.msFullscreenElement) {
        ...
        data.forEach(function (s) {
           ...
           /*  sidebarHTML += '<h6 class="card-title">'+s.name+'</h5>'; */
            ...
            sidebarHTML += '<h1 class="card-card-title" style="font-size:50px;">Model: '+s.model +'</h1>';
    ...
    $("#sideBar").html(sidebarHTML);
           ...
           function getSingleProduct(id)
            ...
            sidebarHTML += '<h1 class="card-card-title" style="font-size:50px;">Model: '+data.product.model +'</h1>';
